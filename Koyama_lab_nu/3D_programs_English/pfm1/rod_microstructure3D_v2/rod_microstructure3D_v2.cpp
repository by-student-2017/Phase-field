...
//********************************************************************************
	...
	//printf("Mx(1.0) = ");	scanf(" %lf",&Mx); 	//Mobility	//Mx=1.; 	//Standard value
	//printf("My(1.0) = ");	scanf(" %lf",&My); 	//Mobility	//My=1.; 	//Standard value
	//printf("Mz(1.0) = ");	scanf(" %lf",&Mz); 	//Mobility	//Mz=0.01; 	//Standard value
