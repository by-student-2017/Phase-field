...
int main(void)
{
	...
	double ddphdx_ep_x_abs_ph2, ddphdy_ep_x_abs_ph2, ddphdz_ep_x_abs_ph2;
	double dx_ddphdx_ep_x_abs_ph2, dy_ddphdy_ep_x_abs_ph2, dz_ddphdz_ep_x_abs_ph2;
...
//---------------------------------------------------------------------------------
				...
				//
				dx_ep = aaa*4.0*zeta*(
					 4.0*(pow(dx_s1,3.0)*dxx_s1+pow(dy_s1,3.0)*dxy_s1+pow(dz_s1,3.0)*dxz_s1)*pow(div_s1,-4.0)
				...
				dy_ep = aaa*4.0*zeta*(
					 4.0*(pow(dx_s1,3.0)*dxy_s1+pow(dy_s1,3.0)*dyy_s1+pow(dz_s1,3.0)*dyz_s1)*pow(div_s1,-4.0)
				...
				dz_ep = aaa*4.0*zeta*(
					 4.0*(pow(dx_s1,3.0)*dxz_s1+pow(dy_s1,3.0)*dyz_s1+pow(dz_s1,3.0)*dzz_s1)*pow(div_s1,-4.0)
				...
				//);
				//
				// ddphdx_ep_x_abs_ph2 = d(ep)/d(d(s1)/dx)*(div_s1*div_s1)
				ddphdx_ep_x_abs_ph2 = aaa*4.0*zeta*(
							4.0*pow(dx_s1,3.0)*pow(div_s1,-2.0)
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*
								//-4.0*pow(div_s1,-3.0)*0.5*(div_s1*div_s1)*2.0*dx_s1
								-4.0*pow(div_s1,-1.0)*dx_s1
				);
				ddphdy_ep_x_abs_ph2 = aaa*4.0*zeta*(
							4.0*pow(dy_s1,3.0)*pow(div_s1,-2.0)
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*
								//-4.0*pow(div_s1,-3.0)*0.5*(div_s1*div_s1)*2.0*dy_s1
								-4.0*pow(div_s1,-1.0)*dy_s1
				);
				ddphdz_ep_x_abs_ph2 = aaa*4.0*zeta*(
							4.0*pow(dz_s1,3.0)*pow(div_s1,-2.0)
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*
								//-4.0*pow(div_s1,-3.0)*0.5*(div_s1*div_s1)*2.0*dz_s1
								-4.0*pow(div_s1,-1.0)*dz_s1
				);
				//
				dx_ddphdx_ep_x_abs_ph2 = aaa*4.0*zeta*(
							12.0*pow(dx_s1,2.0)*dxx_s1*pow(div_s1,-2.0)
							//4.0*pow(dy_s1,3.0)*-2.0*pow(div_s1,-3.0)*dx_abs_div_ph
							+4.0*pow(dx_s1,3.0)*-2.0*pow(div_s1,-1.0)*(dx_s1*dxx_s1 + dy_s1*dxy_s1 + dz_s1*dxz_s1)
							//
							+4.0*(pow(dx_s1,3.0)*dxx_s1+pow(dy_s1,3.0)*dxy_s1+pow(dz_s1,3.0)*dxz_s1)*-4.0*pow(div_s1,-1.0)*dx_s1
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*4.0*(dx_s1*dxx_s1 + dy_s1*dxy_s1 + dz_s1*dxz_s1)*dx_s1
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*-4.0*pow(div_s1,-1.0)*dxy_s1
				);
				dy_ddphdy_ep_x_abs_ph2 = aaa*4.0*zeta*(
							12.0*pow(dy_s1,2.0)*dyy_s1*pow(div_s1,-2.0)
							//4.0*pow(dy_s1,3.0)*-2.0*pow(div_s1,-3.0)*dx_abs_div_ph
							+4.0*pow(dy_s1,3.0)*-2.0*pow(div_s1,-1.0)*(dx_s1*dxy_s1 + dy_s1*dyy_s1 + dz_s1*dyz_s1)
							//
							+4.0*(pow(dx_s1,3.0)*dxy_s1+pow(dy_s1,3.0)*dyy_s1+pow(dz_s1,3.0)*dyz_s1)*-4.0*pow(div_s1,-1.0)*dy_s1
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*4.0*(dx_s1*dxy_s1 + dy_s1*dyy_s1 + dz_s1*dyz_s1)*dy_s1
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*-4.0*pow(div_s1,-1.0)*dyy_s1
				);
				dz_ddphdz_ep_x_abs_ph2 = aaa*4.0*zeta*(
							12.0*pow(dz_s1,2.0)*dzz_s1*pow(div_s1,-2.0)
							//4.0*pow(dy_s1,3.0)*-2.0*pow(div_s1,-3.0)*dx_abs_div_ph
							+4.0*pow(dz_s1,3.0)*-2.0*pow(div_s1,-1.0)*(dx_s1*dxz_s1 + dy_s1*dyz_s1 + dz_s1*dzz_s1)
							//
							+4.0*(pow(dx_s1,3.0)*dxy_s1+pow(dy_s1,3.0)*dyy_s1+pow(dz_s1,3.0)*dyz_s1)*-4.0*pow(div_s1,-1.0)*dz_s1
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*4.0*(dx_s1*dxz_s1 + dy_s1*dyz_s1 + dz_s1*dzz_s1)*dz_s1
							+(pow(dx_s1,4.0)+pow(dy_s1,4.0)+pow(dz_s1,4.0))*-4.0*pow(div_s1,-1.0)*dzz_s1
				);
				//
				...
				//
				term2x = dx_ep*ddphdx_ep_x_abs_ph2
					   + ep*dx_ddphdx_ep_x_abs_ph2;
				term2y = dy_ep*ddphdy_ep_x_abs_ph2
					   + ep*dy_ddphdy_ep_x_abs_ph2;
				term2z = dz_ep*ddphdz_ep_x_abs_ph2
					   + ep*dz_ddphdz_ep_x_abs_ph2;
