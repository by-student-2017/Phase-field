...
//****** Setting calculation conditions and material constants ****************************************
	...
	//
	double *nd1h     = (double *)malloc(sizeof(double)*( ND*ND*ND + ND*ND + ND ));
	double *nd2h     = (double *)malloc(sizeof(double)*( ND*ND*ND + ND*ND + ND ));
	double *nd3h     = (double *)malloc(sizeof(double)*( ND*ND*ND + ND*ND + ND ));
	//
	double *nd1h2    = (double *)malloc(sizeof(double)*( ND*ND*ND + ND*ND + ND ));
	double *nd2h2    = (double *)malloc(sizeof(double)*( ND*ND*ND + ND*ND + ND ));
	double *nd3h2    = (double *)malloc(sizeof(double)*( ND*ND*ND + ND*ND + ND ));
