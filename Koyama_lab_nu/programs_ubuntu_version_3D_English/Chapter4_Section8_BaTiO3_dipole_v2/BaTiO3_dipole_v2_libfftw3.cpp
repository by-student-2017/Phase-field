...
//****** Setting calculation conditions and material constants ****************************************
	...
	double *s3h     = (double *)malloc(sizeof(double)*( ND*ND*ND ));	//polarization moment in y direction
	//
	...
	double *s3qrh   = (double *)malloc(sizeof(double)*( ND*ND*ND ));	//Fourier transform of s2 (real part)
	double *s3qih   = (double *)malloc(sizeof(double)*( ND*ND*ND ));	//Fourier transform of s2 (imaginary part)
	...
	//double *ss3qrh  = (double *)malloc(sizeof(double)*( ND*ND*ND ));	//Fourier transform of s2*s2 (real part)
	//double *ss3qih  = (double *)malloc(sizeof(double)*( ND*ND*ND ));	//Fourier transform of s2*s2 (imaginary part)
	...
	double *s3k_dd  = (double *)malloc(sizeof(double)*( ND*ND*ND ));	//dipole-dipole interaction potential
	//
