...
- The stress tensor is obtained from first-principles calculations or molecular dynamics (MD). The diffusion coefficient is obtained from first-principles MD, classical MD, etc. The temperature dependence of the free energy requires phonon calculations.
