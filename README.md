...
Fig. Building a computing environment using WSL2 (ubuntu 22.04 LTS on Windows11). The content displayed will vary depending on the user's environment, but as long as no errors are displayed, that's fine.
