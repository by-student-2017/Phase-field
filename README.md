...
- It would be good if you could read the TDB file, but please try to draw the phase diagram at the desired temperature using CALPHAD software such as pycalphad, opencalphad, thermo-calc, pandat, etc. If the desired phase is not found, you will need to obtain the information using various methods.
