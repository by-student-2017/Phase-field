...
- The stress tensor is obtained from first-principles calculations or molecular dynamics. The diffusion coefficient is obtained from first-principles MD or classical MD. The temperature dependence of the free energy requires phonon calculations.
