...
- Note 0: A space is required immediately after "=" (no space immediately before "="). A space is required immediately before "!". It is a good idea to align the "!" characters. This is done to simplify the code.
