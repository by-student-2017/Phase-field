...
- The values ​​of representative parameters and methods for calculating approximate values ​​are described in "Thermodynamics of Microstructures" (Japan Institute of Metals) (in Japanese). The subjects and their values ​​are shown in diagrams, so if your local library has it, it's a good idea to take a look at it.
